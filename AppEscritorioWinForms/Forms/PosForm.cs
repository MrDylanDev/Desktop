...
namespace app_escritorio.Forms
{
    ...
    /// Todo el diseño está en PosForm.Designer.cs y se edita en el diseñador; aquí solo va la lógica.
    /// </summary>
    public partial class PosForm : Form
    {
        ...
        private void EditNote(OrderLine line)
        {
            ...
            {
                if (dialog.ShowDialog(TopLevelControl ?? this) == DialogResult.OK)
                {
        ...
        private void BtnCobrar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (checkout.ShowDialog(TopLevelControl ?? this) != DialogResult.OK || !checkout.PaymentConfirmed) return;
                ...
                using (var preview = new ReceiptDialog(receipt.ToString()))
                    preview.ShowDialog(TopLevelControl ?? this);
            }
